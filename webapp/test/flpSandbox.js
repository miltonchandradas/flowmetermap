		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flowmeter Map",
									"targetURL": "#comaquah2oflowmetermap-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaquah2oflowmetermap-display": {
								"semanticObject": "comaquah2oflowmetermap",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aqua.h2oflowmetermap",
									"url": sap.ui.require.toUrl("com/aqua/h2oflowmetermap")
								}
							}
						}
					}
